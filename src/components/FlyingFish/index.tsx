...
const FlyingFish: React.FC<{
    ...
    const mainJS = () => {
        var RENDERER = {
            POINT_INTERVAL: 5, // 控制生成水面浪花的时间间隔和幅度（值越大，间隔和幅度都越大）
            FISH_COUNT: 3, // 鱼的数量
            MAX_INTERVAL_COUNT: 50, // 最大的生成鱼的间隔时间
            INIT_HEIGHT_RATE: 0.45, // 水面占画布的高度比率
            THRESHOLD: 50, // 鱼初始化时在多远的位置，值越大，到达可视页面的时间越长
            ...
            jdugeToStopResize: function () {
                var width = this.$window.offsetWidth,
    ...
    return (
        <div ref={container} className={classnames(styles.container, className)} style={style}></div>
    )
}
